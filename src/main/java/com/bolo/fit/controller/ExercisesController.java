...
public class ExercisesController {
    ...
    @GetMapping("feed-cache")
    private Response<Void> feedCache(){
        Response<Void> response = new Response<>();
        exerciseService.initiateFeedCache();
        return response;
    }
    ...
    private Response<Page<ExerciseResponseDTO>> listaExercicios(
            ...
            @RequestParam(value = "getBase64",  defaultValue = "false") Boolean getBase64,
        ...
        response.setOk().setData(exerciseService.buscaTodosExercicios(paginacaoRequestData, getBase64));
        return response;
    }
